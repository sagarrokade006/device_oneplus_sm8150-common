...
public class Constants {
    ...
    static final String UPDATE_PREFS_ACTION = "com.everest.device.DeviceSettings.UPDATE_SETTINGS";
    static final String SLIDER_UPDATE_ACTION = "com.everest.device.DeviceSettings.UPDATE_SLIDER";
