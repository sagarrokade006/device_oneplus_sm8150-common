...
*
*/
package com.everest.device.DeviceSettings.ModeSwitch;

import android.content.Context;
import android.content.Intent;
import android.content.SharedPreferences;

import com.everest.device.DeviceSettings.Constants;
import com.everest.device.DeviceSettings.Utils;
...
public class HBMModeSwitch {
    ...
    public static void setEnabled(boolean enabled, Context context) {
        ...
        Intent hbmIntent = new Intent(context,
                com.everest.device.DeviceSettings.HBMModeService.class);
