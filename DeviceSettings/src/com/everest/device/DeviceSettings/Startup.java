...
*
*/
package com.everest.device.DeviceSettings;

import static android.content.pm.PackageManager.COMPONENT_ENABLED_STATE_DISABLED;
import static android.content.Intent.ACTION_BOOT_COMPLETED;
import static android.content.Intent.ACTION_LOCKED_BOOT_COMPLETED;

import static com.everest.device.DeviceSettings.FPSInfoService.PREF_KEY_FPS_STATE;
import static com.everest.device.DeviceSettings.ModeSwitch.DCModeSwitch.KEY_DC_SWITCH;
...
import com.everest.device.DeviceSettings.ModeSwitch.*;
...
public class Startup extends BroadcastReceiver {
    ...
    private static final String PKG_NAME = "com.everest.device.DeviceSettings";
