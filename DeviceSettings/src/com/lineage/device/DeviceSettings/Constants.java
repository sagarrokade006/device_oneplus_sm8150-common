...
public class Constants {
    ...
    static final String UPDATE_PREFS_ACTION = "com.lineage.device.DeviceSettings.UPDATE_SETTINGS";
    static final String SLIDER_UPDATE_ACTION = "com.lineage.device.DeviceSettings.UPDATE_SLIDER";
