...
*
*/
package com.lineage.device.DeviceSettings.ModeSwitch;

import android.content.Context;
import android.content.Intent;
import android.content.SharedPreferences;

import com.lineage.device.DeviceSettings.Constants;
import com.lineage.device.DeviceSettings.Utils;
...
public class HBMModeSwitch {
    ...
    public static void setEnabled(boolean enabled, Context context) {
        ...
        Intent hbmIntent = new Intent(context,
                com.lineage.device.DeviceSettings.HBMModeService.class);
